...
import ProxyQ from '../proxy/ProxyQ.js';
...
var ScaleBar =React.createClass({
    ...
    render:function(){
        if(this.state.data$initialed!==true&&(this.props.data==null||this.props.data==undefined))
        {
            ...
            return (
                <div className={this.props.className!==undefined&&this.props.className!==null?("sidebar"+" "+this.props.className):"sidebar"} ref="sidebar">
                    {susp_nav}
