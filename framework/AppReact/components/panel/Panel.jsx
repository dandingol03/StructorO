 ...
 * 9.panel开始支持多数据源
 * 10.Radio组件重写
 * 11.componentWillReceiveProps,会造成某些托管数据丢失
 *
 *
 *
 *
                    ...
                    if(name!==undefined&&name!==null)
                    {
                        if(coms.length>1) {
                            if (coms[1] !== null && coms[1] != undefined && coms[1] !== 'download') {
                                label = (<td key={td$index++} className="w20" colSpan={1}>
                                    {name}
                                </td>);
                            }
                        ...
                        if(coms[0]=='query')
                        {
                            ...
                            {
                                tds.push(
                                    <td key={td$index++} colSpan={j==row.length-1?max$cols-j:1}>
                                        {ctrl}
                                    </td>);
                    ...
                    if(reserved[coms[1]]!==undefined&&reserved[coms[1]]!==null)
                    {
                        ...
                        switch(coms[1])
                        {
                                ...
                                if(state.bean!==null&&state.bean!==undefined) {
                                    if (Object.prototype.toString.call(coms[0].split("=>")) == '[object Array]' && coms[0].split("=>").length >= 2) {
                                        ...
                                        if(coms[2]!==undefined&&coms[2]!==null)
                                        {
                                            ...
                                            ctrl = <button name='queryButton-bigger' type='submit' onClick={clickHandle}
                                                               data-query={coms[2]}> {coms[0]}</button>;

                                        }
                                        else
                                            ctrl = <button name='queryButton-smallest' type='submit' onClick={clickHandle}> {coms[0]}</button>;

                                    }
                                }
                                else
                                    ctrl=<button name="queryButton" type='submit' onClick={clickHandle} >{coms[0]}</button>;
                            ...
                            case 'span':
                                ...
                                if (coms[2] !== undefined && coms[2] !== null)
                                {
                                    ...
                                    if (re !== null && re !== undefined)
                                    {
                                        ...
                                        ctrl = <div className="dangerous scrolling"
                                                    dangerouslySetInnerHTML={{__html:coms[2]}}>
                                               </div>
                                        else
                                            ctrl = <div className="dangerous"
                                                        dangerouslySetInnerHTML={{__html:coms[2]}}>
                                            </div>
                                    }
                                    else {
                            ...
                            case 'textarea':
                                ...
                                {
                                    ctrl = <textarea rows={4} name={coms[0]}
